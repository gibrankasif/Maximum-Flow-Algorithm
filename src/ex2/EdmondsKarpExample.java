...
public class EdmondsKarpExample {
    ...
    private static class EdmondsKarpSolver extends NetworkFlowSolverBase {
        ...
        /**
         * Creates an instance of a flow network solver. Use the {@link  (int, int, int)} method
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        NetworkFlowSolverBase solver = graphReader("ladder_9.txt");
...
//        for (List<Edge> edges : resultGraph) for (Edge e : edges) System.out.println(e.toString(s, t));
    ...
    public static EdmondsKarpSolver graphReader(String fileName) throws FileNotFoundException {
        try {
            EdmondsKarpSolver graph;
            ...
            graph = new EdmondsKarpSolver(number,0, number- 1);
